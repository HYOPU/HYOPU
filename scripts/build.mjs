...
for(const file of ['index.html','sof.html','styles.css','sof-refresh.css','dashboard.css','dashboard-refresh.css','template.css','templates/agent-sof.xlsx'])await copyFile(file,`dist/${file}`);
