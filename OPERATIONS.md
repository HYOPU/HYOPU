...
- The supplied September/October 2026 ETA image is transcribed in `eta-seed.json`. It is a clearly labelled public reference snapshot, not a live shipping feed. AM/PM/?? and source ordering/highlights are preserved. Shared workspace changes are never written into that public bundle.
