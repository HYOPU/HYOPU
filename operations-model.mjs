...
export function hydrateSeed(rows) {
  return rows.map((row, i) => ({ ...row, id: `eta-2026-${String(i + 1).padStart(3, '0')}`, year: 2026, status: row.remark === 'INPORT' ? 'INPORT' : 'PRE-ARRIVAL', activities: [], cargo: [], crew: [], tasks: [], notes: '', latestReport: '', reportType: 'DEP.REPORT', reportReceived: '', reportChecked: false, sof: null, revision: 0 }));
}
