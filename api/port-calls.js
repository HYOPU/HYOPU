...
module.exports = async function handler(req,res) {
  ...
  try {
    ...
    const data={};
    for(const key of ['id','vessel','voyage','port','etaRaw','etdRaw','pic','status','year','notes','latestReport','reportType','reportReceived','reportChecked','activities','cargo','crew','tasks','sof','highlight'])if(call[key]!==undefined)data[key]=call[key];
